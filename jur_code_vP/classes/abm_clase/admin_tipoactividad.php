...
$abm = new class_abm(); 
$abm->tabla = 'TipoActividad'; 
$abm->campoId = 'tia_id'; 
$abm->orderByPorDefecto = 'tia_nombre DESC'; 
...
$abm->campos = array( 
	array('campo' => 'tia_nombre', 
		'tipo' => 'texto',
		'requerido' => true,
		'maxLen' => 50,
		'titulo' => 'Actividad'
	), 
	array('campo' => 'tia_diaprevio', 
		'tipo' => 'texto',
		'requerido' => true,
		'maxLen' => 5,
		'titulo' => 'Dias Visualización Previa'
	), 
	array('campo' => 'tia_diapos', 
		'tipo' => 'texto',
		'requerido' => true,
		'maxLen' => 5,
		'titulo' => 'Días Visualización Posterior'
	), 
	array('campo' => 'tia_popup', 
		'tipo' => 'texto',
		'requerido' => true,
		'maxLen' => 2,
		'titulo' => 'Visualizar como Pendiente'
	),
    array('campo' => 'tia_verificar',
        'tipo' => 'texto',
        'requerido' => true,
        'maxLen' => 2,
        'titulo' => 'Verificar'
...
$abm->generarAbm('', 'Administrar TipoActividad'); 
