...
$abm = new class_abm(); 
$abm->tabla = 'Jurisdicciones'; 
$abm->orderByPorDefecto = 'jur_nombre ASC';
$abm->campoId = 'jur_id'; 
...
$abm->campos = array( 
	array('campo' => 'jur_nombre', 
		'tipo' => 'texto',
	    'tituloListado' => 'Jurisdicciones',
		'requerido' => true,
		'maxLen' => 50,
		'titulo' => 'Jur nombre'
	)
); 
$abm->generarAbm('', 'Administrar Jurisdicciones');  
